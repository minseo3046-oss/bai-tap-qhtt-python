...
class BaiToanQuyHoachTuyenTinh:
    ...
    def nap_du_lieu_tu_bien_ngoai(self, loai_muc_tieu, so_bien, he_so_f, cac_rang_buoc, dau_cua_bien):
        """
        Hàm này dùng để nhận dữ liệu từ UI (hoặc từ code đọc file Excel) 
        truyền thẳng vào class mà không cần qua terminal input.
        """
        self.loai_muc_tieu = loai_muc_tieu
        self.so_bien_goc = so_bien
        self.he_so_f_goc = he_so_f
        self.cac_rang_buoc = cac_rang_buoc
        self.dau_cua_bien = dau_cua_bien
